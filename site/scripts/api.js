...
async function getUserGUID(uid) {
    try {
        return (await soapRequest("UsersGetUserGUID", {"lpszUserName": uid})).getElementsByTagName("AS:szUserGUID")[0].innerHTML
    } catch (e) {
        alert(e)
        return null
    }
...
async function login(uid) {
    try {
        ...
        return JSON.parse(responseXml.getElementsByTagName("AS:szLoginJson")[0].innerHTML)
    } catch (e) {
        alert(e)
        return null
    }
